...
(define-key js2-refactor-mode-map (kbd "<C-S-down>") 'move-text-down)
(define-key js2-refactor-mode-map (kbd "<C-S-up>") 'move-text-up)

(require 'js2-imenu-extras)
(js2-imenu-extras-setup)

;; override js2r--guard because of jsx errors in js2-mode
(defadvice js2r--guard (around my-js2r--guard-advice activate) t)
